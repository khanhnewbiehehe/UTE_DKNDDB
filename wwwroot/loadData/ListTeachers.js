...
function loadDataTable() {
    dataTable = $('#loadDatateacher').DataTable({
        "ajax": {
        ...
        "columns": [
            ...
            //},
            {
                ...
                "render": function (data) {
                    return ` 
                        <a title="Đặt lại mật khẩu" href="/admin/teacher/reset-password/${data}" class='btn btn-primary btn-pd text-white ml-0 mr-0' style='cursor:pointer;'>
                         ...
                         <a title="Chỉnh sửa thông tin" href="/admin/teacher/edit/${data}" class='btn btn-primary btn-pd text-white ml-0 mr-0' style='cursor:pointer;'>
                            <svg width="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <a title="Xóa giảng viên" class='btn btn-danger text-white btn-pd ml-0 mr-0' style='cursor:pointer'
                            onclick=Delete('/admin/teacher/delete/${data}')>
                           <svg width="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
